// frm changes:
// - Renamed miniz.c -> miniz.cpp.
// - Disabled warning in .cpp (32 bit shift implicitly converted to 64 bits).
// - Configs are defined below as convenience.#
// - Replaced MZ_MALLOC/MZ_REALLOC/MZ_FREE macros with FRM_ equivalents.
...
//#endif
#define MZ_MALLOC(x)     FRM_MALLOC(x)
#define MZ_FREE(x)       FRM_FREE(x)
#define MZ_REALLOC(p, x) FRM_REALLOC(p, x)
